...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
    ...
    c.VERSION = "3.3.0", c.DEFAULTS = {
        ...
        var a = !0,
            b = this.$element.closest('[data-toggl="buttons"]');
        if (b.length) {
    ...
    }, a(document).on("click.bs.button.data-api", '[data-toggl^="button"]', function(c) {
        var d = a(c.target);
        d.hasClass("btn") || (d = d.closest(".btn")), b.call(d, "toggle"), c.preventDefault()
    }).on("focus.bs.button.data-api blur.bs.button.data-api", '[data-toggl^="button"]', function(b) {
    ...
    d.VERSION = "3.3.0", d.TRANSITION_DURATION = 350, d.DEFAULTS = {
        ...
        return a(this.options.parent).find('[data-toggl="collapse"][data-paren="' + this.options.parent + '"]').each(a.proxy(function(c, d) {
            var e = a(d);
    ...
    }, a(document).on("click.bs.collapse.data-api", '[data-toggl="collapse"]', function(d) {
        var e = a(this);
    ...
    }, a(document).on("click.bs.modal.data-api", '[data-toggl="modal"]', function(c) {
        var d = a(this),
            e = d.attr("href"),
    ...
    c.VERSION = "3.3.0", c.TRANSITION_DURATION = 150, c.prototype.show = function() {
        ...
        function f() {
            g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggl="tab"]').attr("aria-expanded", !1), b.addClass("active").find('[data-toggl="tab"]').attr("aria-expanded", !0), h ? (b[0].offsetWidth, b.addClass("in")) : b.removeClass("fade"), b.parent(".dropdown-menu") && b.closest("li.dropdown").addClass("active").end().find('[data-toggl="tab"]').attr("aria-expanded", !0), e && e()
        }
        var g = d.find("> .active"),
    ...
    a(document).on("click.bs.tab.data-api", '[data-toggl="tab"]', e).on("click.bs.tab.data-api", '[data-toggl="pill"]', e)
}(jQuery), + function(a) {
    "use strict";
